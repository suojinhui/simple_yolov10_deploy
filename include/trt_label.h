#ifndef __TRT_LABEL_H__
#define __TRT_LABEL_H__
...
/* Base class for label management */
class IBaseLabels {
...
class CocoLabels : public IBaseLabels {
public:
    CocoLabels() {
        for(int i = 0 ; i < 80; i ++) {
            string x = "NA";
...
class Bdd100kLabels : public IBaseLabels {
public:
    Bdd100kLabels() {
        for(int i = 0 ; i < 8; i ++) {
            string x = "NA";
